//
// Created by ypopov on 10.04.2020.
//
...
/*
int linearSearchGenerate(vector <Passenger> passengers, Fio key){
    int elapsed_seconds;
    ...
    cout << "Ups, This passenger is NOT on board. Maybe next time" << endl;
